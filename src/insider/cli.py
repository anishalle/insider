...
from insider.pipeline import build_sequences, label_user_trades, prepare_trades, run_pipeline, smoke_test
...
def main() -> None:
    ...
    for command in ("prepare-trades", "label-user-trades", "build-sequences", "run-pipeline", "smoke-test"):
